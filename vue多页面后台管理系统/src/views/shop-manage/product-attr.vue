<template>
  <div>
    ...
    <el-table :data="dataSub" stripe style="width: 100%" class="category" @row-click="addParent">
         <el-table-column type="expand">
         <template scope="props">
            <el-table :data="dataSub.data" stripe style="width: 100%" class="list-2" >
                <el-table-column type="expand">
                    <template scope="propsThird">
                        <el-table :data="shopSubs" stripe style="width:100%" class="list-2" >
...
export default {
  ...
  data () {
    return {
      ...
      dataSub:[{
        id:'1',
        name:'sdfsdf',
        data:'fd345345ge34564',
        createTime:'6457568567867',
      },
      {
        id:'2',
        name:'safdsdf',
        data:'sdohdgh457657fghfg',
        createTime:'089-09-768568',
      },
      {
        id:'3',
        name:'sdfg',
  ...
  methods:{
     ...
     addTwo(index,row){//点击二级增加
      ...
      console.log(this.addId,this.parentId)
     },
