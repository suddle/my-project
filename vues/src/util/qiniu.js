...
function(global) {
  ...
  function QiniuJsSDK() {
    ...
    function log(a, b) {
      ...
      that.detectIEVersion() ? console.log(d) : (b.unshift(c), console.log.apply(console, b)),
    ...
    this.base64_decode = function(a) {
      ...
      d = j >> 8 & 255,
      e = 255 & j,
      64 === h ? n[l++] = String.fromCharCode(c) : 64 === i ? n[l++] = String.fromCharCode(c, d) : n[l++] = String.fromCharCode(c, d, e);
      while (k < a.length);
      return m = n.join("")
    },
    ...
    this.uploader = function(a) {
      ...
      var e = function(b) {
        ...
        logger.debug("putPolicy: ", e),
        logger.debug("get uphosts from: ", f);
        var g = that.detectIEVersion();
        var h;
        g && 9 >= g ? (h = new mOxie.XMLHttpRequest, mOxie.Env.swf_url = a.flash_swf_url) : h = that.createAjax(),
        h.open("GET", f, !0);
        var i = function() {
          if (logger.debug("ajax.readyState: ", h.readyState), 4 === h.readyState) if (logger.debug("ajax.status: ", h.status), h.status < 400) {
        ...
        g && 9 >= g ? h.bind("readystatechange", i) : h.onreadystatechange = i,
        h.send()
      };
      var f = function(b) {
      ...
      function(b, c) {
        ...
        var d = function(b, c, d) {
          ...
          var i = a.x_vars;
          if (void 0 !== i && "object" == typeof i) for (var j in i) i.hasOwnProperty(j) && ("function" == typeof i[j] ? f["x:" + j] = i[j](b, c) : "object" != typeof i[j] && (f["x:" + j] = i[j]));
          b.setOption({
            url: qiniuUploadUrl,
            multipart: !0,
        ...
        if (i = i || b.settings && b.settings.chunk_size, logger.debug("uploader.runtime: ", p.runtime), logger.debug("chunk_size: ", i), "html5" !== p.runtime && "flash" !== p.runtime || !i) logger.debug("directUpload because uploader.runtime !== 'html5' || uploader.runtime !== 'flash' || !chunk_size"),
        d(b, c, that.key_handler);
        else if (c.size < i || e()) logger.debug("directUpload because file.size < chunk_size || is_android_weixin_or_qq()"),
        d(b, c, that.key_handler);
        else {
      ...
      function(b) {
        return function(c, d, e) {
          ...
          if (l = l ? l: g.ctx, logger.debug("ctx: ", l), l) {
            ...
            m = "",
            n = "";
            if (void 0 !== k && "object" == typeof k) for (var o in k) k.hasOwnProperty(o) && ("function" == typeof k[o] ? m = that.URLSafeBase64Encode(k[o](c, d)) : "object" != typeof k[o] && (m = that.URLSafeBase64Encode(k[o])), n += "/x:" + o + "/" + m);
